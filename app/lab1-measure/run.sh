...
# Paths for DE2-115 sources
 CORE_FILE=../../hardware/nios2_ht18_wang_fu.sopcinfo
SOF_FILE=../../hardware/output_files/nios2_ht18.sof
 JDI_FILE=../../hardware/output_files/nios2_ht18.jdi
...
nios2-bsp hal bsp $CORE_FILE \
	  ...
	  --set hal.make.bsp_cflags_optimization -Os\   #5.1
...
make | tee -a log.txt     #for debug for make command
